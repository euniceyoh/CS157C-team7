...
function createLines({ input, searchFor }) {
...
function hasConnectOrCreate(node, ogm) {
    for (const relation of node.relationFields) {
        const refNode = (0, utils_1.getReferenceNode)(ogm, relation);
...
async function generate(options) {
    ...
    const content = [`import { SelectionSetNode, DocumentNode } from "graphql";`, output];
