...
class OGM {
    constructor(input) {
        ...
        this.neoSchema = new graphql_1.Neo4jGraphQL({
            ...rest,
            typeDefs: (0, utils_1.filterDocument)(typeDefs),
        });
        this.checkNeo4jCompat = function checkNeo4jCompat() {
            var _a;
            return this.neoSchema.checkNeo4jCompat({
                driver: rest.driver,
                ...(((_a = rest.config) === null || _a === void 0 ? void 0 : _a.driverConfig) ? { driverConfig: rest.config.driverConfig } : {}),
            });
        };
    }
    get schema() {
    ...
    model(name) {
        ...
        model = new Model_1.default(name);
        if (this._schema) {
