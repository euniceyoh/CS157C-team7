...
function buildMergeStatement({ sourceNode, targetNode, relationship, context, }) {
    ...
    if (nodeParameters) {
        parameters = (_a = sourceNode.node) === null || _a === void 0 ? void 0 : _a.constrainableFields.reduce((params, field) => {
